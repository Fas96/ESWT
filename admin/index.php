        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a href="index1.html"  ><i class="ti-home"></i> Dashboard </a>
                    </li>
                    ...
                    <li class="label">Apps</li>
                      <li><a class="sidebar-sub-toggle"><i class="ti-email"></i> Questions <span
                        ...
                        <ul>
                            <li><a href="app-email.html">create</a></li>
                            <li><a href="table-export.html">Edit Ques</a></li>
                            <li><a href="table-jsgrid.html">list</a></li>
                        </ul>
                    </li>
                      ...
                      <li><a class="sidebar-sub-toggle"><i class="ti-layout-grid4-alt"></i> Data <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="table-jsgrid.html">students Score list </a></li>
                            <li><a href="table-export.html">Students Data Export</a></li>
                            <li><a href="table-jsgrid.html">Edit Student Data </a></li>
                        </ul>
                    </li>
                    <li><a href="blank.html"><i class="ti-calendar"></i> Rankings </a></li>
                     <li><a class="sidebar-sub-toggle"><i class="ti-headphone-alt"></i> Audio <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="table-export.html">Audio Files Export</a></li>
                            <li><a href="table-jsgrid.html">Edit Students Audio </a></li>
                            <li><a href="audioTest.html">Audio test </a></li>
                        </ul>
                    </li>
